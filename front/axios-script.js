...
async function getDataSet(category) {
  ...
  const dataSet = await axios({
    ...
    url: `http://52.79.90.137:3000/restaurants?category=${qs}`,
...
function getContent(data) {
    ...
    <div class="infowindow">
        ...
        <div class="infowindow-body">
            ...
            <a href="${data.videoUrl}" class="infowindow-btn" target="_blank"></a>
        </div>
    </div>
    `;
}
...
function getCoordsByAddress(address) {
    return new Promise((resolve, reject) => {
        ...
        geocoder.addressSearch(address, function(result, status) {
            ...
            reject(new Error("getCoordsByAddress Error: not valid address error"));
        });
    })
}
